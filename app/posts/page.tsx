...
export const metadata = {
  title: "전체 포스트 | 취업의신 잡프라이즈",
  description:
    "취업의신 잡프라이즈 - 15년 취업 컨설팅 노하우를 담은 모든 콘텐츠를 확인하세요. 취업의신과 함께하는 합격 전략 콘텐츠.",
  keywords: [
    "취업의신",
    "잡프라이즈",
    "취업 콘텐츠",
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <Link href="/posts" className="btn-primary mt-6 inline-block">
              Retry
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {posts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mb-8">
              There are currently no published posts. Check back later for new
              content!
            </p>
          </div>
        )}
